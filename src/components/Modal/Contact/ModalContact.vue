        ...
        <div class="modal__inner" >
          ...
          <div class="priorite">
            ...
            <div class="input-control d-flex flex-column justify-content-start pb-50">
                ...
                <div class=" input-rowswitch d-flex flex-row justify-content-between pb-30">
...
.select-controlwhite select:focus{
    min-width: 300px;
    max-width: 450px;
    font-family: var(--font-family-);
    font-size:14px;
    padding: 5px 10px;
    outline: 1px solid #f8c137d0;;
    border: #f9f9f9 solid 2px;
    color: var( --text-segondary-color);
    border-radius: 2px;
    background-color: #f4f4f4;
